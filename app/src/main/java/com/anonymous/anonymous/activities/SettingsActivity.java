...
import com.anonymous.anonymous.fragments.SettingsFragment;
import com.anonymous.anonymous.view.SeekBarPreference;
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(bitrateStringKey)) {
            ...
            if (bitrateValue > MAX_VIDEO_START_BITRATE){
                Toast.makeText(this, "Max value is:" + MAX_VIDEO_START_BITRATE, Toast.LENGTH_SHORT).show();
                setDefaultstartingBitrate(sharedPreferences);
            }
        }
    }
